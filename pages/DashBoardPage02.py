...
with col1:
    st.subheader("Biểu đồ phân bố mức lương trung bình")
    # Biểu đồ histogram cho mức lương trung bình
    fig = px.histogram(df_filter, x='Lương trung bình', nbins=30, color_discrete_sequence=['skyblue'])
    fig.update_traces(opacity=0.75)
    st.plotly_chart(fig, use_container_width=True)

with col2:
    st.subheader("Mức lương trung bình theo giới tính")
    # Biểu đồ box plot cho mức lương trung bình theo giới tính
